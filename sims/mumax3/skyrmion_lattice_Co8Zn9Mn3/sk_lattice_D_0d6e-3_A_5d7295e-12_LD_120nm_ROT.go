...
func main() {
    ...
    q0 := Vector(0.0, 1.0, 0.0)
    q0 = q0.Mul(F)
    q1 := Vector(-math.Sqrt(3) * 0.5, -0.5, 0.0)
    q1 = q1.Mul(F)
    q2 := Vector(math.Sqrt(3) * 0.5, -0.5, 0.0)
    q2 = q2.Mul(F)

    e0 := Vector(1.0, 0.0, 0.0)
    e1 := Vector(-0.5, math.Sqrt(3) * 0.5, 0.0)
    e2 := Vector(-0.5, -math.Sqrt(3) * 0.5, 0.0)
